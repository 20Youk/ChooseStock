...
star_dict = {'star3': u'三星级',
             'star4': u'四星级',
             'star5': u'五星级'}
area_list = ['chengdu28', 'shanghai2', 'beijing1', 'qingyuan1422']
                ...
                for i in range(0, last_page):
                    ...
                    for hotel in hotel_loc:
                        try:
                            ...
                            total_judgement_score = hotel_detail.findAll("span", {"class": "hotel_value"})[0].get_text()  # 总评分
                    ...
                    # 点击下一页按钮
                    if i < last_page - 1:
                        # next_button = driver.find_element_by_class_name('c_down')
                        # next_button.send_keys(Keys.ENTER)
                        next_button = driver.find_element_by_id('txtpage')
                        next_button.clear()
                        next_button.send_keys(i + 2)
                        time.sleep(10)
