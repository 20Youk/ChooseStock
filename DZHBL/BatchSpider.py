...
class EnterpriseInfoSpider:
    def __init__(self):
        ...
        # 数据字段名17个
        self.fields = ['公司名称', '网站链接', '注册资本', '实缴资本', '经营状态', '成立日期', '法律诉讼', '自身风险', '关联风险']
    ...
    def start(self):
        ...
        while keyword != "end":
            # 先获取keyword第一页内容的页码
            totalpage = self.get_total_page(self.getCatalogPageCode(keyword, 1))
            if totalpage == -1:
                # 请求下一轮查询的关键字
